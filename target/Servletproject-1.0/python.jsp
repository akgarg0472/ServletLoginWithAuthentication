    ...
    <div class="card" style="border-radius: 20px;">
        <div class="text-center mt-2 mb-2">
            <img src="https://camo.githubusercontent."
                 width="250px" height="250px" alt="Python">
        </div>
        <div class="card-body" style="text-align: justify">
            <p>Python is an interpreted, high-level and general-purpose programming language. Python's design philosophy
                ...
                projects.</p>
            <p>Python is dynamically-typed and garbage-collected. It supports multiple programming paradigms, including
                structured (particularly, procedural), object-oriented and functional programming. Python is often
                described as a "batteries included" language due to its comprehensive standard library.</p>
            <p>Guido van Rossum began working on Python in the late 1980's, as a successor to the ABC programming
                ...
                counting and was discontinued with version 2.7.18 in 2020. Python 3.0 was released in 2008 and was a
                major revision of the language that is not completely backward-compatible and much Python 2 code does
                not run unmodified on Python 3. Older Python still supports Windows 7.</p>
        </div>
    </div>
</div>
