...
<head>
    ...
    <style>
        #already-registered-login-url {
            text-decoration: none;
        }

        #already-registered-login-url:hover {
            ...
            <div class="col-md-4 offset-md-4">
                <div class="card">
                        ...
                        <form action="submit_signup_form" method="post" id="signup_form">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" id="signup-confirm-password"
                                       name="signup-confirm-password" placeholder="Confirm Password" autocomplete=""
                                       required>
                            </div>
                    ...
                    <div class="card-footer text-center">
                        <a href="login" id="already-registered-login-url">Already registered, login here</a>
                    </div>
                </div>
            </div>
        </div>
