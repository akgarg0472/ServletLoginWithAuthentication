            ...
            <form action="update-profile-data" method="post" id="update-profile-form">
                <div class="mb-3">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary" id="update-button-edit-profile">Update</button>
                        <a href="profile" class="btn btn-danger" id="cancel-button-edit-profile">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
