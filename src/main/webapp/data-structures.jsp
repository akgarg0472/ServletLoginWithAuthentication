...
<div style="margin: 5% 25% 0 25%; border: 2px solid #ffffff; border-radius: 20px;">
    <div class="card" style="border-radius: 20px;">
        <div class="text-center mt-2 mb-2">
            <img src="https://www.simplilearn.com/ice9/free_resources_article_thumb/Data_structure_interview_questions.jpg"
                 width="250px" height="250px" alt="Data Structures">
        </div>
        <div class="card-body" style="text-align: justify">
            <p>In computer science, a data structure is a data organization, management, and storage format that enables
            ...
            <p>Data structures provide a means to manage large amounts of data efficiently for uses such as large
