...
<nav class="navbar navbar-expand-lg navbar-dark profile-navbar-background">
            ...
            <ul class="d-flex navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-white" aria-current="page"
                       href="profile">Welcome: <strong><%= user == null ? "" : user.getUsername()%>
                    </strong>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="logout">Logout <span
